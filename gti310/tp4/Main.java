...
public class Main {
	...
	public static void main(String[] args) {
		...
		EightXEightBlock testobjet = new EightXEightBlock(eightXEightBlocksContainer[1][1][1].getEightXEightBlockMatrix());
		RLC.iRLCOperation(RLC.rLCOperation(test8x8), testobjet);
